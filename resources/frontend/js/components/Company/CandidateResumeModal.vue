...
<transition name="fade">
    <div v-if="show" class="tw-fixed tw-top-0 tw-left-0 tw-right-0 tw-z-50 tw-p-4 tw-overflow-y-auto md:tw-inset-0 h-modal md:tw-h-full tw-flex tw-items-center tw-justify-center tw-bg-gray-800 tw-bg-opacity-90 modal fade show" id="candidate-profile-modal" style="display: block;">
                    ...
                    <div class="row">
                        <div class="col-lg-8">
                            <div class="biography-wrap">
                                ...
                                <div v-if="social.facebook || social.twitter || social.linkedin || social.youtube || social.instagram">
                                        ...
                                        <div class="social-media">
                                            <ul>
                                                <li v-if="social.facebook">
                                                    <a :href="candidate.social_info" class="bg-primary-50 text-primary-500 plain-button icon-56 hover:bg-primary-500 hover:text-primary-50">

                                                        <svg width="20" height="20" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                            <path d="M12.1666 20H8.20126V10.1414H5.5V6.9316H8.20116V4.64762C8.20116 1.9411 9.39588 0 13.3505 0C14.1869 0 15.5 0.168134 15.5 0.168134V3.14858H14.1208C12.7155 3.14858 12.1668 3.5749 12.1668 4.75352V6.9316H15.4474L15.1553 10.1414H12.1667L12.1666 20Z" fill="currentColor" />
                                                        </svg>
                                                    </a>
                                                </li>
                                                <li v-if="social.twitter">
                                                    <a :href="social.twitter" class="bg-primary-50 text-primary-500 plain-button icon-56 hover:bg-primary-500 hover:text-primary-50">

                                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img" iconify--bx width="24" height="24" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24" data-icon="bx:bxl-twitter">
                                                ...
                                                <li v-if="social.instagram">
                                                    <a :href="social.instagram" class="bg-primary-50 text-primary-500 plain-button icon-56 hover:bg-primary-500 hover:text-primary-50">
                                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true" role="img" iconify--bx width="1em" height="1em" preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24" data-icon="bx:bxl-youtube">
                                        ...
                                        <div class="col-lg-12">
                                            <ul class="nav nav-tabs tw-gap-x-6 !tw-border-b !tw-border-[#E3E5E6]" id="myTab" role="tablist">
                                                <li class="nav-item" role="presentation">
                                                    <button class="ll-nav-link nav-link active" id="home-tab" data-bs-toggle="tab" data-bs-target="#home" type="button" role="tab" aria-controls="home" aria-selected="true">{{__('cover_letter')  }}</button>
                                                </li>
                                                <li class="nav-item" role="presentation">
                                                    <button class="ll-nav-link nav-link" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile" type="button" role="tab" aria-controls="profile" aria-selected="false">
                                                        {{ __('about_me') }}
                                                    </button>
                                                </li>
                                            </ul>
                                            <div class="tab-content" id="myTabContent">
                                                <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                                    <div class="tw-py-6 tw-flex tw-flex-col tw-gap-3 tw-text-base tw-text-[#5E6670]">
                                                ...
                                                <div class="tab-pane fade " id="profile" role="tabpanel" aria-labelledby="profile-tab">
                                                    <div class="tw-py-6">
                                                        <h4 class="tw-text-lg tw-font-medium tw-leading-[100%] tw-text-[#18191C]">
                                                            {{ __('biography') }}</h4>
                                                        <p class="tw-text-base tw-text-[#5E6670]" id="candidate-bio">{{ candidate . bio }} </p>
                                                        <h4 class="tw-text-lg tw-font-medium tw-leading-[100%] tw-text-[#18191C] tw-mb-4 text-uppercase">
                                                            {{ __('experience') }}</h4>
                                                        <ul class="tw-p-0 tw-m-0 tw-list-none ll-experience-list">
                                                            <li v-for="experience in candidate.experiences" :key="experience.id" class="tw-text-sm tw-flex tw-flex-col tw-gap-3">
                                                                <div class="tw-flex tw-flex-col tw-gap-1">
                                                                    <p class="tw-m-0 tw-text-sm tw-text-[#0066CC] tw-font-medium -tw-mt-1.5">
                                                                        {{ experience.formatted_start }}</p>
                                                                    <h4 class="tw-m-0 tw-text-sm tw-text-[#14181A] tw-font-medium">
                                                        ...
                                                        <ul class="tw-p-0 tw-m-0 tw-list-none ll-experience-list" id="education-container">
                                                            <li v-for="education in candidate.educations" :key="education.id" class="tw-text-sm tw-flex tw-flex-col tw-gap-3">
                                                                <div class="tw-flex tw-flex-col tw-gap-1">
                                                                    <p class="tw-m-0 tw-text-sm tw-text-[#0066CC] tw-font-medium -tw-mt-1.5" id="candidate-edu-year">
                                                                        {{ education.year }}</p>
                                                                    <h4 class="tw-m-0 tw-text-sm tw-text-[#14181A] tw-font-medium">
                                                                        {{ education.degree }}</h4>
                                                                    <p class="tw-m-0 tw-text-sm tw-text-[#707A7D]">
                                ...
                                <div class="row">
                                    <div class="col-md-12" v-if="candidate.skills && candidate.skills.length">
                                        ...
                                        <div class="tw-flex tw-flex-wrap tw-gap-2 tw-mb-6">
                                            <span class="tw-bg-[#E7F0FA] tw-rounded-[4px] tw-text-sm tw-text-[#0A65CC] tw-px-3 tw-py-1.5" v-for="skill in candidate.skills" :key="skill.id">
                                                {{ skill . name }}
                                            </span>
                                        </div>
                                    </div>
                                    <div class="col-md-12" v-if="candidate.languages && candidate.languages.length">
                                        ...
                                        <div class="tw-flex tw-flex-wrap tw-gap-2 tw-mb-6">
                                            <span class="tw-bg-[#E7F0FA] tw-rounded-[4px] tw-text-sm tw-text-[#0A65CC] tw-px-3 tw-py-1.5" v-for="language in candidate.languages" :key="language.id">
                                                {{ language . name }}
                                            </span>
                                        </div>
                                    </div>
                                        ...
                                        <div class="icon-box">
                                            <div class="icon-img">
                                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M12 8.25V6" stroke="var(--primary-500)" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                                    <path d="M12 6C16.3312 4.5 12 0.75 12 0.75C12 0.75 7.5 4.5 12 6Z" stroke="var(--primary-500)" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                                    <path d="M15.1875 11.8125C15.1875 12.6579 14.8517 13.4686 14.2539 14.0664C13.6561 14.6642 12.8454 15 12 15C11.1546 15 10.3439 14.6642 9.7461 14.0664C9.14832 13.4686 8.8125 12.6579 8.8125 11.8125" stroke="var(--primary-500)" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="icon-box">
                                            <div class="icon-img">
                                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M9 14.25H15" stroke="var(--primary-500)" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                                    <path d="M9 11.25H15" stroke="var(--primary-500)" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                                    ...
                                                    <path d="M8.25 6.75V6C8.25 5.00544 8.64509 4.05161 9.34835 3.34835C10.0516 2.64509 11.0054 2.25 12 2.25C12.9946 2.25 13.9484 2.64509 14.6517 3.34835C15.3549 4.05161 15.75 5.00544 15.75 6V6.75H8.25Z" stroke="var(--primary-500)" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                                </svg>
                                    ...
                                    <div class="col-md-6">
                                        <div class="icon-box">
                                            <div class="icon-img">
                                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M12 21C16.9706 21 21 16.9706 21 12C21 7.02944 16.9706 3 12 3C7.02944 3 3 7.02944 3 12C3 16.9706 7.02944 21 12 21Z" stroke="var(--primary-500)" stroke-width="1.5" stroke-miterlimit="10" />
                                                    <path d="M12 15C14.0711 15 15.75 13.3211 15.75 11.25C15.75 9.17893 14.0711 7.5 12 7.5C9.92893 7.5 8.25 9.17893 8.25 11.25C8.25 13.3211 9.92893 15 12 15Z" stroke="var(--primary-500)" stroke-width="1.5" stroke-miterlimit="10" />
                                                    <path d="M5.98145 18.6913C6.54639 17.5806 7.40768 16.6478 8.46997 15.9963C9.53226 15.3448 10.7541 15 12.0003 15C13.2464 15 14.4683 15.3448 15.5306 15.9963C16.5929 16.6478 17.4542 17.5806 18.0191 18.6913" stroke="var(--primary-500)" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                                </svg>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="icon-box">
                                            <div class="icon-img">
                                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                    <path d="M0.75 9L12 3L23.25 9L12 15L0.75 9Z" stroke="var(--primary-500)" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                                    <path d="M17.625 22.5V12L12 9" stroke="var(--primary-500)" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                                    <path d="M20.625 10.4004V15.5117C20.6253 15.6735 20.573 15.831 20.476 15.9605C19.8444 16.8009 17.18 19.8754 12 19.8754C6.82004 19.8754 4.15558 16.8009 3.52402 15.9605C3.42699 15.831 3.37469 15.6735 3.375 15.5117V10.4004" stroke="var(--primary-500)" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
                                                </svg>
                            ...
                            <div class="sidebar-widget">
                                <div class="contact">
                                    ...
                                    <div v-if="candidate.whatsapp_number">
                                        <a target="_blank" :href="'https://wa.me/' + candidate.whatsapp_number" class="whatsapp-button" id="contact_whatsapp">
                                            <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
                                                <path d="M11.4182 0.0138947C5.07986 0.315691 0.077995 5.59432 0.0972232 11.9399C0.103078 13.8726 0.569664 15.6968 1.39275 17.3086L0.129022 23.4429C0.0606609 23.7747 0.359933 24.0652 0.689568 23.9872L6.70043 22.5631C8.24472 23.3323 9.97927 23.7766 11.815 23.8046C18.2935 23.9036 23.6953 18.7596 23.8972 12.2836C24.1137 5.34172 18.3844 -0.317864 11.4182 0.0138947ZM18.5905 18.4934C16.8302 20.2537 14.4896 21.2231 12.0002 21.2231C10.5425 21.2231 9.14695 20.8961 7.85212 20.2511L7.01503 19.8341L3.32975 20.7072L4.10548 16.9415L3.69308 16.134C3.02089 14.8175 2.68006 13.394 2.68006 11.903C2.68006 9.4135 3.64951 7.07306 5.40984 5.31267C7.15445 3.56807 9.53312 2.58284 12.0004 2.58284C14.4898 2.5829 16.8302 3.55234 18.5905 5.31261C20.3509 7.07294 21.3203 9.41339 21.3204 11.9028C21.3203 14.3701 20.3351 16.7488 18.5905 18.4934Z" fill="#00C236"></path>
                                                <path d="M17.777 14.4844L15.4714 13.8224C15.1683 13.7353 14.8419 13.8213 14.621 14.0464L14.0572 14.6208C13.8194 14.863 13.4587 14.9409 13.144 14.8136C12.0534 14.3722 9.75907 12.3323 9.17316 11.3119C9.00412 11.0176 9.03207 10.6496 9.23962 10.381L9.73187 9.74418C9.92472 9.49467 9.96542 9.15958 9.83788 8.87116L8.86786 6.67724C8.63551 6.15176 7.96402 5.9988 7.52532 6.36982C6.88184 6.91407 6.11833 7.74111 6.02552 8.65735C5.86188 10.2728 6.55467 12.3091 9.17448 14.7543C12.2011 17.5791 14.6247 17.9523 16.2028 17.57C17.0978 17.3532 17.8131 16.4841 18.2646 15.7725C18.5723 15.2873 18.3293 14.643 17.777 14.4844Z" fill="#00C236"></path>
                                            </svg>
                                    ...
                                    <div class="contact-icon-box">
                                        <div class="icon-img">
                                            <svg width="24" height="24" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path d="M16 28C22.6274 28 28 22.6274 28 16C28 9.37258 22.6274 4 16 4C9.37258 4 4 9.37258 4 16C4 22.6274 9.37258 28 16 28Z" fill="none" stroke="var(--primary-500)" stroke-width="2" stroke-miterlimit="10" />
                                                <path d="M4 16H28" stroke="var(--primary-500)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                                <path d="M16 27.678C18.7614 27.678 21 22.4496 21 16.0001C21 9.55062 18.7614 4.32227 16 4.32227C13.2386 4.32227 11 9.55062 11 16.0001C11 22.4496 13.2386 27.678 16 27.678Z" stroke="var(--primary-500)" stroke-width="2" stroke-miterlimit="10" />
                                            </svg>
                                    ...
                                    <div class="contact-icon-box">
                                        <div class="icon-img">
                                            <svg width="24" height="24" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                <path opacity="0.2" d="M16 3C13.3478 3.00001 10.8043 4.05358 8.92894 5.92894C7.05358 7.8043 6.00001 10.3478 6 13C6 22 16 29 16 29C16 29 26 22 26 13C26 10.3478 24.9464 7.8043 23.0711 5.92894C21.1957 4.05358 18.6522 3.00001 16 3ZM16 17C15.2089 17 14.4355 16.7654 13.7777 16.3259C13.1199 15.8864 12.6072 15.2616 12.3045 14.5307C12.0017 13.7998 11.9225 12.9956 12.0769 12.2196C12.2312 11.4437 12.6122 10.731 13.1716 10.1716C13.731 9.61216 14.4437 9.2312 15.2196 9.07686C15.9956 8.92252 16.7998 9.00173 17.5307 9.30448C18.2616 9.60723 18.8864 10.1199 19.3259 10.7777C19.7654 11.4355 20 12.2089 20 13C20 14.0609 19.5786 15.0783 18.8284 15.8284C18.0783 16.5786 17.0609 17 16 17V17Z" fill="var(--primary-500)" />
                                                <path d="M7 29H25" stroke="var(--primary-500)" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" />
                                                <path d="M16 17C18.2091 17 20 15.2091 20 13C20 10.7909 18.2091 9 16 9C13.7909 9 12 10.7909 12 13C12 15.2091 13.7909 17 16 17Z" stroke="var(--primary-500)" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" />
                                                <path d="M26 13C26 22 16 29 16 29C16 29 6 22 6 13C6 10.3478 7.05357 7.8043 8.92893 5.92893C10.8043 4.05357 13.3478 3 16 3C18.6522 3 21.1957 4.05357 23.0711 5.92893C24.9464 7.8043 26 10.3478 26 13V13Z" stroke="var(--primary-500)" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" />
                                            </svg>
                                    ...
                                    <div class="contact-icon-box">
                                        <div class="icon-img">
                                            <svg width="24" height="24" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <path d="M19.9268 5C21.622 5.45592 23.1677 6.34928 24.409 7.59059C25.6503 8.8319 26.5437 10.3776 26.9996 12.0728" stroke="var(--primary-500)" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" />
                                                <path d="M18.8916 8.86523C19.9087 9.13879 20.8362 9.6748 21.5809 10.4196C22.3257 11.1644 22.8618 12.0918 23.1353 13.1089" stroke="var(--primary-500)" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" />
                                            </svg>
