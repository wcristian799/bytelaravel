            ...
            <form action="{{ route('settings.affiliate.default') }}" method="POST">
                ...
                <div class="d-flex">
                    <select name="job_provider" class="form-control">
                        ...
                        @if (config('zakirsoft.default_job_provider'))
                        <option value="">{{ __('disable_all') }}</option>
                        @endif
                        <option {{ config('zakirsoft.default_job_provider') == 'careerjet' ? 'selected' : '' }} value="careerjet">
                            Careerjet Jobs
                        </option>
                        <option {{ config('zakirsoft.default_job_provider') == 'indeed' ? 'selected' : '' }} value="indeed">
                            Indeed Jobs
                        </option>
                    </select>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-7">
                                <select name="job_limit" id="careerjet_job_limit"
                                    ...
                                    <option
                                        {{ config('zakirsoft.careerjet_limit') == 50 ? 'selected' : '' }}
                                        value="50">
                                        50
                                    </option>
                                </select>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-7">
                                <select name="job_limit" class="form-control mr-sm-2 @error('job_limit') is-invalid @enderror" id="indeed_job_limit">
                                    ...
                                    <option
                                        {{ config('zakirsoft.indeed_limit') == 50 ? 'selected' : '' }}
                                        value="50">
                                        50
                                    </option>
                                </select>
