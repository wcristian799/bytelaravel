                ...
                <form id="formSubmit" action="{{ route('job.index') }}" method="GET" onchange="this.submit();">
                    <div class="card-body border-bottom row">
                        ...
                        <div class="col-2">
                            ...
                            <select name="job_category" class="form-control select2bs4 w-100-p">
                                <option value="">
                                    {{ __('all') }}
                                </option>
                        ...
                        <div class="col-2">
                            ...
                            <select name="job_type" class="form-control select2bs4 w-100-p">
                                <option value="">
                                    {{ __('all') }}
                                </option>
                        ...
                        <div class="col-2">
                            ...
                            <select name="experience" class="form-control select2bs4 w-100-p">
                                <option value="">
                                    {{ __('all') }}
                                </option>
                        ...
                        <div class="col-2">
                            ...
                            <select name="filter_by" class="form-control select2bs4 w-100-p">
