                            ...
                            <div class="row" id="company-input-container">
                                ...
                                <div class="col-sm-12 form-group hidden" id="company_name_container">
                                    <label for="company_name">
                                        {{__('company_name')}}
                                        <span class="text-red font-weight-bold hidden">*</span></label>
                                    <input id="company_name" type="text" name="company_name" placeholder="{{__('company_name')}}" class="form-control "
