                    ...
                    <form id="filterForm" action="{{ route('order.index') }}" method="GET">
                        <div class="card-body border-bottom row">
                            ...
                            <div class="col-3">
                                ...
                                <select name="provider" id="filter" class="form-control select2bs4 w-100-p">
                            ...
                            <div class="col-3">
                                <label>{{ __('plan') }}</label>
                                <select name="plan" class="form-control select2bs4 w-100-p">
                            ...
                            <tbody>
                                @forelse ($orders as $order)
                                    <tr>
                                        ...
                                        <td>
                                            {{ currencyPosition(
                                                currencyConversion($order->usd_amount, 'USD', config('zakirsoft.currency', 'USD'))
