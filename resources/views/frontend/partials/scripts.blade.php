...
<script>
    ...
    $(document).ready(function() {
        ...
        // Store the currently selected radio button value
        let selectedRadioValue = "{{ Route::current()->hasParameter('category') ? Route::current()->parameter('category') : '' }}";
        // Update the form action based on selected radio button
        ...
        radioButtons.on("change", function() {
            selectedRadioValue = $(this).data('id');
            updateFormAction();
        });
    });
</script>
