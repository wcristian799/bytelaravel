        ...
        <div class="modal-content tw-rounded-none tw-relative tw-max-h-screen">
            ...
            <div class="tw-p-5">
                ...
                <div class="tw-flex tw-justify-between tw-items-center tw-mb-4">
                    <p class="tw-text-sm tw-text-[#767F8C] tw-mb-0">Min: {{ $currentCurrency->symbol }}<span>0</span></p>
                    <p class="tw-text-sm tw-text-[#767F8C] tw-mb-0">Max: {{ $currentCurrency->symbol }}<span>{{ round($maxSalary, 0) }}</span></p>
                </div>
                <div class="tw-flex tw-gap-2 tw-items-center tw-py-2">
                    <input {{ request('price_min') == 10 && request('price_max') == 100 ? 'checked' : '' }}
                        onclick="changeSalary(10, 100)" type="radio" id="10" class="tw-scale-125"
                        name="salleryRange">
                    <label for="10" class="tw-text-sm tw-text-[#18191C] tw-mt-[2px]">{{ $currentCurrency->symbol }}10 -
                ...
                <div class="tw-flex tw-gap-2 tw-items-center tw-py-2">
                    <input {{ request('price_min') == 100 && request('price_max') == 1000 ? 'checked' : '' }}
                        ...
                        name="salleryRange">
                    <label for="100" class="tw-text-sm tw-text-[#18191C] tw-mt-[2px]">{{ $currentCurrency->symbol }}100
                        -
                ...
                <div class="tw-flex tw-gap-2 tw-items-center tw-py-2">
                    <input {{ request('price_min') >= 1000000 && !request('price_max') ? 'checked' : '' }}
                        ...
                        name="salleryRange">
                    <label for="100000Up"
                        class="tw-text-sm tw-text-[#18191C] tw-mt-[2px]">{{ $currentCurrency->symbol }}100,000 Up</label>
                </div>
            </div>
            </div>
