                            ...
                            <div class="mb-2 d-flex align-items-center justify-content-between">
                                ...
                                @if($plan->profile_verify)
                                    ...
                                    <svg
                                        ...
                                        width="34" height="34"
                                        xmlns="http://www.w3.org/2000/svg" fill="green" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                                ...
                                @else
                                    ...
                                    <svg
                                        style="margin-right: -10px"
                                        width="34" height="34"
                                        xmlns="http://www.w3.org/2000/svg" fill="red" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" >
