                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="custom-control custom-radio custom-control-inline">
                                                        <input type="radio" id="profile_verify_yes" name="profile_verify" class="plan_type_selection custom-control-input" value="1" checked>
                                                        <label class="custom-control-label" for="profile_verify_yes">{{ __('yes') }}</label>
                                                    </div>
                                                    <div class="custom-control custom-radio custom-control-inline">
                                                        <input type="radio" id="profile_verify_no" name="profile_verify" class="plan_type_selection custom-control-input" value="0">
