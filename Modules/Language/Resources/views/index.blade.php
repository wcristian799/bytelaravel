                                ...
                                @forelse ($languages as $key => $language)
                                    <tr>
                                        ...
                                        <td class="d-flex justify-content-center align-items-center">
                                            ...
                                            @if ($language->code == 'en')
                                                <a data-toggle="tooltip" data-placement="top" title="{{ __('translate_language') }}" href="javascript:void(0)" class="btn btn-warning mt-0 mr-2"
                                                    data-toggle="tooltip" title="You can't delete or edit this language">
                                                    <i class="fas fa-lock"></i>
                                                </a>
                                            @endif
                                            @if ($language->code != 'en')
                                                <a data-toggle="tooltip" data-placement="top" title="{{ __('sync_language_contents') }}" onclick="return confirm('{{ __('are_you_sure') }}');" href="{{ route('language.syncLanguage', $language->id) }}" class="btn btn-primary mt-0 mr-2">
                                                    <i class="fas fa-sync"></i>
                                                </a>
                                                <a data-toggle="tooltip" data-placement="top" title="{{ __('edit_language') }}" href="{{ route('languages.edit', $language->id) }}" class="btn btn-info mt-0 mr-2">
